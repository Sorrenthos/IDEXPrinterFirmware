...
#define STRING_CONFIG_H_AUTHOR "(Timothy Bell, BL touch and Z min Probe)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "IDEX"
...
// :[1, 2, 3, 4, 5]
// Extruders has been changed to 2, heated chamber is separate system
#define EXTRUDERS 2
 ...
 */
//Changed, this is not the correct definition for dual x carriage. It is in configuration_adv
...
#define USE_ZMIN_PLUG // turned on for bltouch
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -2.95   // Z offset: -below +above  [the nozzle]
...
// Direction of endstops when homing; 1=MAX, -1=MIN // Z was set to min for BLtouch
// :[-1,1]
#define X_HOME_DIR -1
#define Y_HOME_DIR -1
#define Z_HOME_DIR -1
